      ...
      <div className="flex gap-6 h-[1000px]">
        ...
        {/* <div className="w-1/2 bg-white space-y-5 rounded-lg shadow-md p-6 overflow-y-scroll">
          ...
          <h3 className="text-lg">
            ...
            going to rent about companies that she could rent furniture from.
            First, you have some time to look at questions 1 to 5. Now listen
          ...
          <h3 className="text-xl font-bold">
            SHELLEY MAYER:
            <span className="font-normal">
              Sure. It's just to get a general idea of how much it's gonna cost.
          ...
          <h3 className="text-xl font-bold">
            MAN:
            <span className="font-normal">
              There's another company called Larch Furniture. It's quite new,
