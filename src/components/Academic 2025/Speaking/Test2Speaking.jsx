...
const questionKeywords = [
  ["favourite", "fruit", "like", "prefer", "choice", "taste"],
  ["dislike", "fruit", "hate", "don't like", "avoid", "unpleasant"],
  ["cooked food", "fruit", "dish", "recipe", "ingredients", "eat"],
  ["best place", "buy", "fruit", "market", "shop", "local", "store"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">
            Fruit Preferences and Purchases
          </h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>What's your favourite fruit?</li>
            <li>Are there any kinds of fruit that you don't like eating?</li>
            <li>Do you like eating cooked food that has fruit in it?</li>
            <li>Where's the best place to buy fruit where you live?</li>
          </ul>
        </div>
...
export default Test2Speaking2025;
