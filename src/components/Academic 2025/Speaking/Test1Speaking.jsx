...
const questionKeywords = [
  ["walking", "daily life", "exercise", "activity", "regular", "routine"],
  ["walk", "school", "past", "then", "now", "compare"],
  ["places", "walk", "near", "around", "neighborhood", "park", "area"],
  ["walking holiday", "vacation", "travel", "trip", "hike", "nature"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">
            Walking in Daily Life and Beyond
          </h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>How much walking do you do in your daily life?</li>
            <li>Did you walk more when you were at school than now?</li>
            <li>What places are there to go for a walk near where you live?</li>
            <li>Would you ever like to go on a walking holiday?</li>
          </ul>
        </div>
...
export default Test1Speaking2025;
