...
import Speaking4Pagination2025 from "../Pagination 2025/Speaking4Pagination2025";

const Test4Speaking2025 = () => {
...
const questions = [
  ...
  "Do you have the same personal qualities as your parents?",
  "What personal qualities are important to you in a friend?",
  "Do you think you have the personal qualities to be a good or successful leader?",
];
...
const questionKeywords = [
  ...
  ["personal qualities", "parents", "similar", "like", "inherit", "family"],
  ["personal qualities", "friend", "important", "value", "traits", "character"],
  ["personal qualities", "leader", "good", "successful", "skills", "abilities"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">
            Personal Qualities: Self, Family, Friendship, and Leadership
          </h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>What do you think your best personal qualities are?</li>
            <li>Do you have the same personal qualities as your parents?</li>
            <li>What personal qualities are important to you in a friend?</li>
            <li>
              Do you think you have the personal qualities to be a good or
              successful leader?
            </li>
          </ul>
        </div>
...
<Speaking4Pagination2025></Speaking4Pagination2025>
    </div>
  );
};

export default Test4Speaking2025;
