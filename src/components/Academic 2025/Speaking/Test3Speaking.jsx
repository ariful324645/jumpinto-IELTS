...
const questionKeywords = [
  ["enjoy", "museum", "childhood", "visit", "experience", "like"],
  ["interesting", "museum", "near", "local", "around", "place", "visit"],
  ["best", "museum", "yourself", "friends", "company", "go", "visit"],
  ["visit", "city", "country", "important", "museum", "travel", "sightseeing"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">
            Childhood to Present: Museum Visits and Choices
          </h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>Did you enjoy going to museums when you were a child?</li>
            <li>Are there any interesting museums near where you live now?</li>
            <li>
              Do you think it is best to go to museums by yourself or with
              friends?
            </li>
            <li>
              When you visit another city or country, do you think it's
              important to go to a museum there?
            </li>
          </ul>
        </div>
...
export default Test3Speaking2025;
