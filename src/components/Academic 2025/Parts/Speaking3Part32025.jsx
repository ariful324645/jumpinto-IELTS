...
import Speaking3Pagination2025 from "../Pagination 2025/Speaking3Pagination2025";

const Speaking3Part32025 = () => {
...
const questionKeywords = [
  ...
  ["ambitions", "life goals", "positive", "benefit", "motivation"],
  ["important", "components", "satisfying life", "happiness", "well-being"],
  [
    "job satisfaction",
    "high salary",
    "colleagues",
  ...
  ["change jobs", "regularly", "satisfied", "career", "work happiness"],
  ["job satisfaction", "all types of work", "possible", "career", "enjoyment"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Satisfaction and Dissatisfaction: In Life and at Work
            </h1>

            <li>
              What are some aspects of people's lives that they can often be
              dissatisfied with?
            </li>
            <li>
              Would you say that having ambitions in life is always a positive
              thing?
            </li>
            <li>
              What do you believe the most important components are of a
              satisfying life?
            </li>
            <li>
              What makes a job more satisfying: a high salary or having good
              colleagues?
            </li>
            <li>
              Do you think people need to change jobs regularly if they want to
              stay satisfied at work?
            </li>
            <li>
              Is it possible to find job satisfaction in all types of work?
            </li>
      ...
      <Speaking3Pagination2025></Speaking3Pagination2025>
    </div>
  );
};

export default Speaking3Part32025;
