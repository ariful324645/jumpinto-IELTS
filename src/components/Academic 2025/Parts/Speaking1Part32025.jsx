...
import Speaking1Pagination2025 from "../Pagination 2025/Speaking1Pagination2025";

const Speaking1Part32025 = () => {
...
const questionKeywords = [
  ["popular", "plays", "shows", "theatres", "country"],
  ["easy", "get tickets", "theatre", "booking", "availability"],
  ["theatres", "attract", "younger audiences", "young people", "improve"],
  ["attracts", "working", "actor", "career", "interest"],
  ["qualities", "become an actor", "skills", "talent", "personality"],
  ["disadvantages", "working as an actor", "challenges", "problems", "stress"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Theatre in Your Country: Plays, Tickets, Young Audiences, and
              Acting Careers
            </h1>

            <li>
              What are the most popular kinds of plays or shows at theatres in
              your country?
            </li>
            <li>How easy is it to get tickets to the theatre?</li>
            <li>
              Do you think theatres need to do more to attract younger
              audiences?
            </li>
            <li>What do you think attracts people to working as an actor?</li>
            <li>
              What are some of the qualities that a person needs to have if they
              want to become an actor?
            </li>
            <li>Can you think of any disadvantages of working as an actor?</li>
          </ul>
        </div>
      ...
      <Speaking1Pagination2025></Speaking1Pagination2025>
    </div>
  );
};

export default Speaking1Part32025;
