...
const questionKeywords = [
  ["find out", "news", "people", "country", "sources", "media"],
  ["local news", "national news", "interest", "attention", "focus"],
  ["international news", "importance", "global events", "knowledge", "world"],
  ["discussion programmes", "public", "popular", "TV", "radio", "audience"],
  ["participants", "people", "discussion programmes", "interest", "type"],
  ["influence", "people", "good", "bad", "effects", "impact"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              News and Discussion Programmes: Local, National, and International
            </h1>

            <li>How do most people find out about the news in your country?</li>
            <li>
              Are people more interested in local news than national news?
            </li>
            <li>How important is it to know about international news?</li>
            <li>
              Why are discussion programmes involving members of the public
              popular on TV and radio?
            </li>
            <li>
              What kinds of people want to take part in discussion programmes?
            </li>
...
export default Speaking4Part32025;
