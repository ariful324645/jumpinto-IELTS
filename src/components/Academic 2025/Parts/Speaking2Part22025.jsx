...
const Speaking2Part22025 = () => {
 ...
 const questionKeywords = [
   ["original plan", "first plan", "initial plan", "idea", "decided"],
   ["changed", "why", "reason", "problem", "situation"],
   ["new plan", "made", "decided", "alternative", "final plan"],
 ];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A time when you changed a plan you had made
            </h1>
            ...
            <li>what your original plan was</li>
            <li>why you changed it</li>
            <li>what new plan you made</li>
          </ul>
...
export default Speaking2Part22025;
