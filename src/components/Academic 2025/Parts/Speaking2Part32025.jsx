...
import Speaking2Pagination2025 from "../Pagination 2025/Speaking2Pagination2025";

const Speaking2Part32025 = () => {
...
const questionKeywords = [
  ["plans", "friends", "together", "activities", "future"],
  ["discuss", "future plans", "friends", "family", "better"],
  ["making plans", "copy", "friends", "independent", "decision"],
  ["choosing", "study", "course", "career", "important"],
  ["work experience", "future career", "before deciding", "benefit", "idea"],
  ["change career", "one career to another", "easy", "switch", "profession"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Planning for the Future: Friendship, Education, and Career
              Transitions
            </h1>

            <li>What kinds of plans do friends make together?</li>
            <li>
              Do you think it's better to discuss future plans with friends or
              with family?
            </li>
            <li>
              When making plans for the future, is it important not to copy
              friends?
            </li>
            <li>
              When people are choosing what to study, how important is it that
              their course should lead directly to a career?
            </li>
            <li>
              Why is it a good idea to get some work experience before deciding
              on a future career?
            </li>
            <li>
              How easy do you think it is for people to change from one career
              to another?
            </li>
          </ul>
        </div>
      ...
      <Speaking2Pagination2025></Speaking2Pagination2025>
    </div>
  );
};

export default Speaking2Part32025;
