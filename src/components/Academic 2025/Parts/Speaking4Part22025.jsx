...
const questionKeywords = [
  ["news story", "article", "report", "topic", "story content"],
  ["discussed", "talked with", "friend", "family", "colleagues"],
  ["opinions", "people's views", "feedback", "thoughts", "reaction"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>what the news story was about</li>
            <li>who you discussed this news story with</li>
            <li>what people's opinions were</li>
          </ul>

          <p className="text-lg font-bold mt-3">
            and explain why you had such a long discussion about this news
            story.
          </p>
        </div>
...
export default Speaking4Part22025;
