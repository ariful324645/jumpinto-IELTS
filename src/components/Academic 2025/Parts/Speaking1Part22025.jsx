...
const questions = [
  "What play or film would you like to go to see again?",
  "Who would you go with?",
  "What other people have said about this play or film?",
];

const questionKeywords = [
  ["play", "film", "movie", "theatre", "cinema", "see again"],
  ["who", "go with", "friend", "family", "partner"],
  ["other people", "said", "review", "opinion", "feedback"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A play or a film you have seen that you would like to see again
              with friends
            </h1>

            <p className="text-lg font-bold">
              Describe a play or a film you have seen that you would like to see
              again with friends.
            </p>

            <p className="text-lg font-bold">You should say:</p>

            <li>what play or film you’d like to go to see again</li>
            <li>who you would go with</li>
            <li>what other people have said about this play or film</li>
          </ul>

          <p className="text-lg font-bold mt-3">
            and explain why you would like to see this play or film again with
            friends.
          </p>
        </div>
...
export default Speaking1Part22025;
