...
const questionKeywords = [
  ["piece of work", "project", "task", "assignment", "work was"],
  ["why", "did", "reason", "purpose", "motivation"],
  ["who", "what helped", "support", "teacher", "friend", "family", "tools"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A piece of work you did for your job or your studies that you felt
              very satisfied with
            </h1>

            <p className="text-lg font-bold">
              Describe a piece of work you did for your job or your studies that
              you felt very satisfied with.
            </p>

            <p className="text-lg font-bold">You should say:</p>

            <li>what this piece of work was</li>
            <li>why you did this piece of work</li>
            <li>who or what helped you to do this work</li>
          </ul>
...
export default Speaking3Part22025;
