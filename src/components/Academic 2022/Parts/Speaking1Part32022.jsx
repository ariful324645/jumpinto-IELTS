...
const questionKeywords = [
  ["neighbours", "help", "support", "community", "relationship", "friendship"],
  ["people", "know", "neighbours", "community", "country", "interaction"],
  ["important", "good", "relationship", "trust", "neighbourhood", "community"],
  ["facilities", "cities", "amenities", "infrastructure", "people", "living"],
  ["shopping", "local shops", "city centre", "differences", "buy", "stores"],
  ["children", "school", "nearest", "education", "attendance", "location"],
];
...
export default Speaking1Part32022;
