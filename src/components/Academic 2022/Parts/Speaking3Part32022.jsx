...
import Speaking3Pagination2022 from "../Pagination2022/Speaking3Pagination2022";

const Speaking3Part32022 = () => {
...
const questionKeywords = [
  ["monuments", "tourists", "visiting", "places", "famous", "interest"],
  ["statues", "famous people", "public places", "reason", "symbol", "history"],
  ["old", "monuments", "buildings", "preserve", "agree", "opinion"],
  ["architecture", "university", "popular", "study", "subject", "design"],
  ["homes", "design", "changed", "recent years", "housing", "architecture"],
  ["design", "buildings", "mood", "effect", "people", "experience"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Public monuments & Architecture
            </h1>

            <p className="text-lg font-bold">Public monuments</p>
            <li>
              What kinds of monuments do tourists in your country enjoy
              visiting?
            </li>
            <li>
              Why do you think there are often statues of famous people in
              public places?
            </li>
            <li>
              Do you agree that old monuments and buildings should always be
              preserved?
            </li>

            <p className="text-lg font-bold mt-4">Architecture</p>
            <li>Why is architecture such a popular university subject?</li>
            <li>
              In what ways has the design of homes changed in recent years?
            </li>
            <li>
      ...
      <Speaking3Pagination2022></Speaking3Pagination2022>
    </div>
  );
};

export default Speaking3Part32022;
