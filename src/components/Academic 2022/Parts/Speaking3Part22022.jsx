...
const questionKeywords = [
  ["monument", "place", "landmark", "historical", "famous", "site"],
  ["location", "where", "city", "country", "area", "place"],
  ["appearance", "look", "design", "structure", "features", "architecture"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>What this monument is</li>
            <li>Where this monument is</li>
...
export default Speaking3Part22022;
