...
import Writing1Pagination2022 from "../Pagination2022/Writing1Pagination2022";

const Writing1Part22022 = () => {
  ...
  return (
    <div className="px-3">
            ...
            {openScript ? (
              <div>
                ...
                <p className="mt-5">
                  ...
                  routines. <br /> <br /> Critics rightly note that reckless risk-taking can
                  lead to financial loss or emotional distress. Failed business
      ...
      <Writing1Pagination2022></Writing1Pagination2022>
    </div>
  );
};

export default Writing1Part22022;
