...
import Speaking1Pagination2022 from "../Pagination2022/Speaking1Pagination2022";

const Speaking1Part22022 = () => {
...
const questions = [
  "Where in your town or city the neighbourhood was?",
  "What kind of people lived there?",
  "What was it like to live in this neighbourhood?",
];

const questionKeywords = [
  ["town", "city", "neighbourhood", "area", "location"],
  ["people", "residents", "community", "neighbours", "locals"],
  ["live", "life", "experience", "environment", "feeling"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>Where in your town or city the neighbourhood was</li>
            <li>What kind of people lived there</li>
            <li>What it was like to live in this neighbourhood</li>
          </ul>
          <p className="text-lg font-bold mt-3">
            and explain whether you would like to live in this neighbourhood in
            the future.
          </p>
        </div>
...
export default Speaking1Part22022;
