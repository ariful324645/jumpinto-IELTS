...
const questionKeywords = [
  ["task", "work", "job", "duty", "assignment", "activity"],
  ["hurry", "rush", "urgent", "reason", "pressure", "deadline"],
  ["well", "performance", "result", "success", "quality", "experience"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>Why you had to do this in a hurry</li>
            <li>How well you did this</li>
          </ul>
...
export default Speaking4Part22022;
