...
const questionKeywords = [
  ["big city", "visit", "destination", "travel", "place", "tourism"],
  ["travel", "transport", "journey", "way", "mode", "trip"],
  ["activities", "do", "things", "explore", "experience", "plan"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A big city you would like to visit
            </h1>
            ...
            <li>Which big city you would like to visit</li>
            <li>How you would travel there</li>
            <li>What you would do there</li>
          </ul>
...
export default Speaking2Part22022;
