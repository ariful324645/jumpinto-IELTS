        ...
        <div className="w-1/2 bg-white space-y-5 rounded-lg shadow-md p-6 overflow-y-scroll">
          ...
          <div>
            <h1 className="text-2xl font-bold mb-5 text-center">
              {renderText("The development of the London underground railway")}
            </h1>
            ...
            <p className="text-lg">
              ...
              {renderText(" Crossing the City became a nightmare.")}
              {renderText(
            ...
            <p className="text-lg">
              ...
              {renderText(" However, Pearson and his partners persisted.")}
            </p>
            ...
            <p className="text-lg">
              ...
              {renderText(
                " These were built over the next five years, reaching Moorgate in the east of London and Hammersmith in the west."
              )}
              {renderText(" ")}
              <span
                className={`ml-2 ${
            ...
            <p className="text-lg">
              {renderText(
                "It wasn't until the development of a reliable electric motor that the world's first deep-level electric railway became possible."
              )}
              {renderText(
                " The City & South London line opened in 1890 and ran from the City to Stockwell."
              )}
              <span
                className={`ml-2 ${
                  highlight ? "bg-yellow-100" : "bg-transparent"
              ...
              >
                {renderText(
                  " The carriages were narrow and had tiny windows because it was thought passengers would not want to look at the tunnel walls."
                )}
                {highlight && (
                  <span className="inline-flex items-center justify-center w-8 h-6 bg-yellow-700 rounded-sm text-white font-semibold">
                    11
              ...
              {renderText(
                " Although it was a great technical achievement, it did not make a profit."
              )}
              <span
                className={`ml-2 ${
                  highlight ? "bg-yellow-100" : "bg-transparent"
            ...
            <p className="text-lg">
              {renderText(
                "In 1900, the Central London Railway, known as the 'Tuppenny Tube', began operation."
              )}
              {renderText(
                " It was extremely popular and new lines and extensions soon followed."
              )}
              {renderText(
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll ">
          ...
          <div className="border p-5 space-y-4">
            <h3 className="text-xl font-bold text-center mb-4">
              {renderText("The London underground railway")}
            </h3>
            ...
            <ul className="list-disc list-inside space-y-4 text-lg">
              ...
              <li className="flex flex-wrap items-center gap-2">
                <span>
                  {renderText("Move people to better housing in the")}
                </span>
                <button
              ...
              {/* 3 */}
              <li className="flex flex-wrap items-center gap-2">
                <span>{renderText("A number of")}</span>
                <button
                ...
                />
                <span>{renderText("agreed with Pearson's idea")}</span>
              </li>

              {/* 4 */}
              <li className="flex flex-wrap items-center gap-2">
                <span>{renderText("Problems getting the")}</span>
                <button
                ...
                />
                <span>{renderText("needed for the project")}</span>
              </li>

              {/* 5 */}
              <li className="flex flex-wrap items-center gap-2">
                <span>{renderText("Negative articles appeared in the")}</span>
                <button
              ...
              {/* 6 */}
              <li className="flex flex-wrap items-center gap-2">
                <span>{renderText("Tunnel was covered with")}</span>
                <button
