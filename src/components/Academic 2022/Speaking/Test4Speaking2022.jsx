...
const questionKeywords = [
  ["paper map", "phone", "digital", "navigation", "GPS", "technology"],
  ["last time", "map", "travel", "direction", "need", "situation"],
  ["new city", "map", "direction", "travel", "explore", "location"],
  ["read", "maps", "easy", "difficult", "direction", "skill"],
];
    ...
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <br />
          <h2 className="text-2xl font-bold mb-2">Maps</h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>
              Do you think it's better to use a paper map or a map on your
              phone? Why?
            </li>
            <li>
              When was the last time you needed to use a map? Why or why not?
            </li>
            <li>
              If you visit a new city, do you always use a map to find your way
              around? Why or why not?
            </li>
            <li>
              In general, do you find it easy to read maps? Why or why not?
            </li>
          </ul>
        </div>
