...
const questions = [
  ...
  "If people visit you in your home, what do you usually offer them to drink? Why or why not?",
];

const questionKeywords = [
  ["drink", "dinner", "water", "juice", "soft drink", "meal"],
  ["water", "daily", "healthy", "habit", "hydration", "body"],
  ["tea", "coffee", "prefer", "caffeine", "taste", "energy"],
  ["guest", "home", "offer", "drink", "hospitality", "visit"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>What do you like to drink with your dinner? Why?</li>
            <li>Do you drink a lot of water every day? Why or why not?</li>
            <li>Do you prefer drinking tea or coffee? Why?</li>
            <li>
              If people visit you in your home, what do you usually offer them
              to drink? Why or why not?
            </li>
          </ul>
        </div>
...
export default Test3Speaking2022;
