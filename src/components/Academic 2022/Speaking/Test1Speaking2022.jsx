...
const questionKeywords = [
  ["school", "history", "lesson", "past", "war", "civilization"],
  ["enjoy", "like", "interesting", "boring", "fun", "difficult"],
  ["watch", "TV", "programme", "documentary", "often", "history"],
  ["period", "ancient", "modern", "medieval", "future", "learn"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>Did you enjoy studying history at school? Why or why not?</li>
            <li>
              How often do you watch TV programmes about history now? Why or why
              not?
            </li>
            <li>
