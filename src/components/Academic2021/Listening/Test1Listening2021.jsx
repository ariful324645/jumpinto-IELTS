...
const Test1Listening2021 = () => {
  ...
  return (
    <div className="px-3">
      <div
        className="w-full bg-white space-y-5 rounded-lg shadow-md p-6 overflow-y-scroll"
        onMouseUp={handleTextSelect} // detect text selection
      >
        <h1 className="text-xl font-bold">PART 1</h1>
        ...
        <h3 className="text-lg">
          ...
          {renderText(
            "Part 1. You will hear a man phoning to find out about some children's engineering workshops. First, you have some time to look at questions 1 to 3. Now listen carefully and answer questions 1 to 3."
          )}
        </h3>
        ...
        <h3 className="text-lg">
          <span className="font-bold">SARAH:</span>{" "}
          {renderText(
            "Hello, children's engineering workshops. For example, they work together to design a special cover that goes round an egg."
          )}
        </h3>
        ...
        <h3 className="text-lg">
          ...
          {renderText(
            "Oh, hello. I wanted some information about the workshops."
          )}
        </h3>
      </div>

      {/* Modal under the selected text */}
      {isModalOpen && (
        <div
