...
const questions = [
  ...
  "What information did the review give about the product or service?",
];

const questionKeywords = [
  ["where", "read", "review", "website", "platform", "source"],
  ["product", "service", "what", "item", "business"],
  ["information", "details", "review", "quality", "price", "experience"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A review you read about a product or service
            </h1>
            ...
            <li>where you read the review</li>
            <li>what the product or service was</li>
            <li>
...
export default Speaking2Part22021;
