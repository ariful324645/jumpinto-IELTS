...
const questionKeywords = [
  ["when", "where", "got", "technology", "device", "acquired"],
  ["why", "started", "using", "technology", "reason", "motivation"],
  ["why", "decided", "stop", "using", "technology", "quit"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              Some technology that you decided to stop using
            </h1>

            <p className="text-lg font-bold">
              Describe some technology (e.g. an app, phone, software program)
              that you decided to stop using.
            </p>

            <p className="text-lg font-bold">You should say:</p>

            <li>when and where you got this technology</li>
            <li>why you started using this technology</li>
            <li>why you decided to stop using it</li>
          </ul>
...
export default Speaking4Part22021;
