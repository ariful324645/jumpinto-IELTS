...
import Speaking3Pagination2021 from "../Pagination 2021/Speaking3Pagination2021";

const Speaking3Part32021 = () => {
...
const questionKeywords = [
  ...
  ["buy", "expensive items", "friends", "themselves", "motives"],
  ["rich people", "difficult", "become rich", "money", "wealth", "success"],
  ["money", "happiness", "agree", "life", "wealth", "wellbeing"],
  ["rich people", "money", "help", "society", "charity", "donate"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Expensive items & Rich people
            </h1>

            <p className="text-lg font-bold">Expensive items</p>
            <li>
              Which expensive items would many young people (in your country)
              like to buy?
            </li>
            <li>
              How do the expensive items that younger people want to buy differ
              from those that older people want to buy?
            </li>
            <li>
            ...
            <p className="text-lg font-bold mt-4">Rich people</p>
            <li>How difficult is it to become very rich in today's world?</li>
            <li>
              Do you agree that money does not necessarily bring happiness?
            </li>
            <li>
      ...
      <Speaking3Pagination2021></Speaking3Pagination2021>
    </div>
  );
};

export default Speaking3Part32021;
