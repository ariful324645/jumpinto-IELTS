...
const questionKeywords = [
  ["tourist", "attraction", "place", "location", "spot"],
  ["when", "why", "visited", "visit", "time", "reason"],
  ["did", "activities", "experience", "things", "enjoyed"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A tourist attraction you enjoyed visiting
            </h1>
...
export default Speaking1Part22021;
