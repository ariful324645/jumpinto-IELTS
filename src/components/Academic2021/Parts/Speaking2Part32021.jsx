...
import Speaking2Pagination2021 from "../Pagination 2021/Speaking2Pagination2021";

const Speaking2Part32021 = () => {
...
const questionKeywords = [
  ["online reviews", "people", "write", "country", "products", "services"],
  ["why", "people", "write reviews", "reasons", "opinions", "experience"],
  [
    "online reviews",
    "good",
    "shoppers",
  ...
  ["customer service", "job", "work", "experience", "role"],
  ["customers", "complain", "nowadays", "complaints", "behavior"],
  [
    "important",
    "companies",
    "customer complaints",
  ...
  return (
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <p className="text-lg font-bold">Online reviews</p>
            <li>
              What kinds of things do people write online reviews about in your
              country?
            </li>
            <li>Why do some people write online reviews?</li>
            <li>
              Do you think that online reviews are good for both shoppers and
              companies?
            </li>

            <p className="text-lg font-bold mt-4">Customer service</p>
            <li>
              What do you think it might be like to work in a customer service
              job?
            </li>
            <li>
              Do you agree that customers are more likely to complain nowadays?
            ...
            <li>
              How important is it for companies to take all customer complaints
              seriously?
            </li>
          </ul>
        </div>
      ...
      <Speaking2Pagination2021></Speaking2Pagination2021>
    </div>
  );
};

export default Speaking2Part32021;
