...
const Test4Speaking2019 = () => {
  ...
  const questionKeywords = [
    ...
    ["do", "activities", "neighbourhood", "free time", "leisure", "things"],
    [
      "new",
      "things",
      "neighbourhood",
    ...
    ["live", "another", "neighbourhood", "town", "city", "relocation", "move"],
  ];
    ...
    <div className="p-6 flex justify-between">
      ...
      <div className="flex-1">
        ...
        <ul className="list-disc pl-8 list-inside space-y-2">
          <h1 className="text-2xl font-bold text-center">Your neighbourhood</h1>
          <li>Do you like the neighbourhood you live in? [Why/Why not?]</li>
          <li>
            What do you do in your neighbourhood in your free time? [Why/Why
            not?]
          </li>
          <li>
            What new things would you like to have in your neighbourhood?
          ...
          <li>
            Would you like to live in another neighbourhood in your town or
            city? [Why/Why not?]
          </li>
        </ul>
      </div>
...
export default Test4Speaking2019;
