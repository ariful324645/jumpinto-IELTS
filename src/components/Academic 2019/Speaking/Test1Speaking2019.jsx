...
const Test1Speaking2019 = () => {
  ...
  const questionKeywords = [
    ["job", "career", "future", "work", "profession", "ambition"],
    ["english", "language", "communication", "future", "useful", "benefit"],
    ["travel", "trip", "journey", "visit", "places", "abroad"],
    ["life", "change", "future", "plans", "goals", "difference"],
  ];
...
export default Test1Speaking2019;
