...
const questionKeywords = [
  ["see", "neighbours", "frequency", "meet", "visits", "interaction"],
  ["invite", "neighbours", "home", "visit", "gathering", "socialize"],
  ["good", "neighbour", "friendly", "helpful", "relationship", "behaviour"],
  ["help", "assistance", "neighbour", "support", "favor", "aid"],
];
    ...
    <div className="p-6 flex justify-between">
      ...
      <div className="flex-1">
        ...
        <ul className="list-disc pl-8 list-inside space-y-2">
          ...
          <li>How often do you see you see your neighbours? [Why/Why not?]</li>
          <li>Do you invite your neighbours to your home? [Why/Why not?]</li>
          <li>Do you think you are a good neighbour? [Why/Why not?]</li>
          <li>Has a neighbour ever helped you? [Why/Why not?]</li>
        </ul>
      </div>
      {/* right div */}
...
export default Test3Speaking2019;
