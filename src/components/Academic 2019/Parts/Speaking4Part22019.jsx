...
const questionKeywords = [
  ["website", "online store", "platform", "site", "e-commerce"],
  ["bought", "purchase", "item", "product", "order", "things"],
  ["satisfied", "happy", "pleased", "experience", "content", "feedback"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A website you have bought something from
            </h1>
...
export default Speaking4Part22019;
