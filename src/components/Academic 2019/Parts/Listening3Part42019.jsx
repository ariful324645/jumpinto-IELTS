  ...
  const lines = [
    ...
    },
    {
      ...
      text: [
        ...
        "And we'll hear it alongside works written by British composers, Edward Elgar, and more recently, Thomas Adès.",
      ],
    },
    {
      speaker: "ANNOUNCER",
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll ">
          ...
          <div className="overflow-x-auto border p-5 bg-white rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-3 mt-6">
              ...
              <li className="text-lg">
                <span>
                  {renderText("British composers: Edward Elgar, Thomas Adès")}
                </span>
              </li>
            </ul>
          </div>
