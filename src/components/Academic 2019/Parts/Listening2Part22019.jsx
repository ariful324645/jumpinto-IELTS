...
const Listening2Part22019 = () => {
  ...
  const lines = [
    {
      speaker: "ANNOUNCER",
      text: [
        "Section 2. You will hear a guide talking to a group of tourists who are about to visit an English castle.",
...

    {
      ...
      text: [
        ...
        "So, in fact, there's been a castle on this site for over eleven hundred years.",
        "The first building was a fort, constructed in 914 AD, for defense against Danish invaders.",
        "By King Alfred the Great's daughter, who ruled England at the time.",
        "In the following century, after the Normans conquered England, the land was given to a nobleman called Richard de Vere.",
        "And he built a castle there that stayed in the de Vere family for over 400 years.",

        {
          text: "However, when Queen Elizabeth I (Queen Elizabeth the first) announced that she was going to visit the castle in 1576, it was beginning to look a bit run down, and it was decided that rather than repair the guest rooms,.they'd make a new house for her, out of wood, next to the main hall.",
          number: 11,
        },
        ...
        "In the 17th century, the castle belonged to the wealthy Fenys family, who enlarged it and made it more comfortable.",
        ...
        {
          text: "It was eventually taken over by a company who owned a number of amusement parks.",
          number: 12,
        },
        "But when we get there, I think you'll see that they've managed to retain the original atmosphere of the castle.",

        {
          text: "When you go inside, you'll find that in the State Rooms, there are lifelike moving wax models dressed in costumes of different periods in the past.",
          number: 13,
        },
        "Which even carry on conversations together.",
        "As well as that, in every room, there are booklets giving information about what the room was used for, and the history of the objects and furniture it contains.",
        "The castle park's quite extensive. At one time sheep were kept there, and in the 19th century the owners had a little zoo with animals like rabbits and even a baby elephant.",
        {
          text: "The park also has some beautiful trees. Though the oldest of all, which dated back 800 years, was sadly blown down in 1987.",
          number: 14,
        },
        "Now you're free to wander around on your own until 4:30.",
        "But then at the end of our visit, we'll all meet together at the bottom of the great staircase.",
        "We'll then go on to the Long Gallery, where there's a wonderful collection of photographs showing the family who owned the castle 100 years ago.",

        {
          text: "Having tea and cakes in the conservatory, and we'll then take you to the same place where afternoon tea will be served to you.",
          number: 15,
        },
        "Enjoy your visit!",
      ],
...

    {
      ...
      text: [
        ...
        {
          text: "The starting point is quite near the main entrance.",
          number: 16,
        },
        "Walk straight down the path until you get to the south gate. And it's just there. Don't go on to the north gate, there's no way up from there.",

        {
          text: "There'll shortly be a show in which you can see archers displaying their skill with a bow and arrow.",
          number: 17,
        },
        ...
        {
          text: "If you like animals, there's also a display of hunting birds, falcons and eagles and so on.",
          number: 18,
        },
        ...
        {
          text: "At 3 pm, there's a short performance of traditional dancing on the outdoor stage.",
          number: 19,
        },
        ...
        {
          text: "It's actually inside one of the towers, but the way in is from the outside.",
          number: 20,
        },
  ...
  // different option
  const questions = [
    "Before Queen Elizabeth I visited Branley Castle in 1576, what was done for her stay?",
    "In 1982, who took over ownership of the castle?",
    "In some of the rooms, what can visitors see?",
    "In the castle park, what can visitors do?",
    "At the end of the visit, what will the group do?",
  ];
...
const correctAnswers = {
  11: "B. a new building was constructed for her",
  12: "C. an entertainment company",
  13: "C. see models of historical figures moving and talking",
  14: "B. go to an art exhibition",
  15: "A. afternoon tea in the conservatory",
  16: "A",
  17: "B",
  18: "C",
  19: "D",
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll pb-10">
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <div className="flex justify-center items-center">
                <div className="">
                  <img
                    className="h-96 w-96"
                    src="https://i.ibb.co.com/5xfYt785/l2.jpg"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="space-y-2">
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              <span>{renderText("Starting point for walking the walls")}</span>
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              <span>{renderText("Bow and arrow display")}</span>
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              {renderText("Hunting birds display")}
              <div className="relative w-40">
                <select
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              {renderText("Traditional dancing")}
              <div className="relative w-40">
                <select
...
export default Listening2Part22019;
