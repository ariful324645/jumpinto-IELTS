...
const Test3Speaking2015 = () => {
  ...
  const questionKeywords = [
    ["enjoy travelling", "like travel", "why", "why not", "experience", "fun"],
    [
      "much travelling",
      "travel experience",
      "often",
    ...
    ["travel alone", "with others", "friends", "family", "better", "why"],
    ["future travel", "want to travel", "destination", "country", "why"],
  ];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Travel</h1>
            <li>Do you enjoy travelling? [Why/Why not?]</li>
            <li>Have you done much travelling? [Why/Why not?]</li>
            <li>
              Do you think it's better to travel alone or with other people?
              [Why?]
            </li>
            <li>Where would you like to travel in the future? [Why?]</li>
          </ul>
        </div>
