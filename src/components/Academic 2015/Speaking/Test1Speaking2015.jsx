...
const Test1Speaking2015 = () => {
  ...
  const questionKeywords = [
    ...
    ["pay bills", "cash", "online", "mobile banking", "card", "why"],
    ["forgotten", "pay a bill", "late payment", "why", "why not"],
    ["make bills cheaper", "save money", "reduce cost", "budget", "cheaper"],
  ];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Paying bills</h1>
            <li>What kinds of bills do you have to pay?</li>
            <li>
              How do you usually pay your bills – in cash or by another method?
              [Why?]
            </li>
            <li>Have you ever forgotten to pay a bill? [Why/Why not?]</li>
            <li>
              Is there anything you could do to make your bills cheaper?
              [Why/Why not?]
            </li>
...
export default Test1Speaking2015;
