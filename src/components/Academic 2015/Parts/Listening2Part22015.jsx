...
const Listening2Part22015 = () => {
  ...
  const correctAnswers = {
    ...
    11: "C", // the SWRDC
    12: "B", // unusual heating system
    13: "B", // cost of the project
    14: "C", // who will open it

    // Questions 15–20 (Matching)
    15: "F", // Asia – mountains
    16: "C", // Antarctic – ice and snow
    17: "I", // South America – volcanoes
    18: "H", // North America – space travel
    19: "G", // Europe – music and film
    20: "E", // Africa – local animals
  };
  ...
  const calculateScore = (answers) => {
    ...
    setScore(newScore);
    localStorage.setItem("/listening2Part22015", newScore);
  };
  ...
  const handleClear = () => {
    ...
    setActiveButtons({});
    setIsOpen(false);
    localStorage.removeItem("/listening2Part22015");
  };

  // --- Restore answers from localStorage (optional) ---
  useEffect(() => {
    const savedScore = localStorage.getItem("/listening2Part22015");
    if (savedScore) {
