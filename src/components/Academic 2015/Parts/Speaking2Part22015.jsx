...
const questions = [
  "What sorts of products or services does it sell?",
  "What does the shop look like?",
  "Where is it located?",
];

const questionKeywords = [
  ["products", "services", "sell", "items", "types", "shop"],
  ["shop", "looks", "appearance", "interior", "design", "layout"],
  ["where", "location", "place", "address", "area", "city"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A shop near where you live that you sometimes use
            </h1>
            ...
            <li>What sorts of products or services it sells</li>
            <li>What the shop looks like</li>
...
export default Speaking2Part22015;
