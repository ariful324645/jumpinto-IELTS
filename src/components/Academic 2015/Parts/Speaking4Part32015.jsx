...
import Speaking4Pagination2015 from "../Pagination 2015/Speaking4Pagination2015";
...
const questionKeywords = [
  ["young people", "things", "want", "own", "desire", "today", "why"],
  ["need", "own things", "motivation", "desire", "reasons", "why"],
  ["lots of things", "happiness", "own", "possessions", "effect", "why"],
  ["television", "films", "media", "influence", "possessions", "effect", "why"],
  ["benefits", "society", "people", "possessions", "impact", "why"],
  ["success", "possessions", "future", "status", "having lots", "why"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Owning things & Salaries for skilled people
            </h1>

            <p className="text-lg font-bold">Owning things</p>
            <li>
              What types of things do young people in your country most want to
              own today? Why?
            </li>
            <li>Why do some people feel they need to own things?</li>
            <li>
              Do you think that owning lots of things makes people happy? Why?
            </li>
            ...
            <li>
              Do you think television and films can make people want to get new
              possessions? Why do they have this effect?
            </li>
            <li>
              Are there any benefits to society of people wanting to get new
              possessions? Why do you think this is?
            </li>
            <li>
              Do you think people will consider that having lots of possessions
              is a sign of success in the future? Why?
            </li>
          </ul>
        </div>
      ...
      <Speaking4Pagination2015></Speaking4Pagination2015>
    </div>
  );
};
