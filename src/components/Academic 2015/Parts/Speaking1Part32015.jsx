...
import Speaking1Pagination2015 from "../Pagination 2015/Speaking1Pagination2015";
...
const questions = [
  ...
  "Are there any other jobs that you think should have high salaries? ",
  "Some people say it would be better for society if everyone got the same salary. What do you think about that?",
];

const questionKeywords = [
  ["skills", "abilities", "people want", "importance", "today", "why"],
  ["children", "learn at school", "learn at home", "skills", "education"],
  ["future skills", "important", "develop", "learn", "why", "future"],
  ["high salaries", "jobs", "country", "well paid", "why", "income"],
  ["other jobs", "high salaries", "deserve", "why", "importance"],
  ["same salary", "society", "everyone", "fair", "equal pay", "opinion", "why"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Skills and abilities & Salaries for skilled people
            </h1>

            <p className="text-lg font-bold">Skills and abilities</p>
            <li>
              What skills and abilities do people most want to have today? Why?
            </li>
            <li>
              Which skills should children learn at school? Are there any skills
              which they should learn at home? What are they?
            </li>
            <li>
            ...
            <li>
              Some people say it would be better for society if everyone got the
