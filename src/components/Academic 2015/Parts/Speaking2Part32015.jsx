...
import Speaking2Pagination2015 from "../Pagination 2015/Speaking2Pagination2015";
...
const questionKeywords = [
  ...
  ["importance", "local businesses", "neighbourhood", "benefit", "community"],
  [
    "large malls",
    "commercial centres",
    "small businesses",
  ...
  ["start business", "entrepreneur", "motivation", "people", "reason"],
  ["disadvantages", "running business", "challenges", "problems", "serious"],
  [
    "qualities",
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Local business & People and business
            </h1>

            <p className="text-lg font-bold">Local business</p>
            <li>
              What types of local business are there in your neighbourhood? Are
              there any restaurants, shops or dentists for example?
            </li>
            <li>
            ...
            <li>
              How do large shopping malls and commercial centres affect small
              local businesses? Why do you think that is?
            </li>

            <p className="text-lg font-bold mt-4">People and business</p>
            <li>Why do some people want to start their own business?</li>
            <li>
              Are there any disadvantages to running a business? Which is the
              most serious?
            </li>
            <li>
              What are the most important qualities that a good business person
              needs? Why is that?
            </li>
          </ul>
        </div>
      ...
      <Speaking2Pagination2015></Speaking2Pagination2015>
    </div>
  );
};
