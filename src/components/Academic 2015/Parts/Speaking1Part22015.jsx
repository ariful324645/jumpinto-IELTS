...
const Speaking1Part22015 = () => {
  ...
  const questionKeywords = [
    ["who", "person", "identity", "friend", "family", "colleague"],
    ["know", "relationship", "friend", "family", "colleague", "how"],
    ["does well", "skills", "ability", "talent", "strength", "why"],
  ];
...
export default Speaking1Part22015;
