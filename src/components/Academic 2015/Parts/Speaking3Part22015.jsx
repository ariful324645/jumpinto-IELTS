...
const questionKeywords = [
  ["child", "who", "identity", "see", "frequency", "how often"],
  ["age", "how old", "years", "birthday", "child"],
  ["personality", "character", "behavior", "traits", "like", "description"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <p className="text-lg font-bold">Describe a child that you know.</p>

            <p className="text-lg font-bold">You should say:</p>

            <li>Who this child is and how often you see him or her</li>
            <li>How old this child is</li>
            <li>What he or she is like</li>
          </ul>
...
export default Speaking3Part22015;
