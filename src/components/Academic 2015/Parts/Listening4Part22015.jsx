...
const Listening4Part22015 = () => {
  ...
  const correctAnswers = {
    ...
    11: "B", // It was convenient for river transport.
    12: "B", // The increase in demand for metals
    13: "A", // Shortage of fuel
    14: "C", // Buildings were used for new purposes
    15: "C", // Rebuild the port complex

    // Questions 16-20 (Notes completion)
    16: "take visitors",
    17: "unsuitable",
    18: "exhibition",
    19: "visit",
  ...
  const calculateScore = (answers) => {
    ...
    setScore(newScore);
    localStorage.setItem("/listening4Part22015", newScore);
  };
  ...
  const handleClear = () => {
    ...
    setActiveButtons({});
    setIsOpen(false);
    localStorage.removeItem("/listening4Part22015");
  };

  // --- Restore answers from localStorage (optional) ---
  useEffect(() => {
    const savedScore = localStorage.getItem("/listening4Part22015");
    if (savedScore) {
