...
const questions = [
  "What is this thing?",
  "How long have you wanted to own it?",
  "Where did you first see it?",
];

const questionKeywords = [
  ["thing", "object", "item", "what", "describe", "details"],
  ["want", "own", "possession", "duration", "how long", "wish"],
  ["first saw", "location", "place", "where", "seen before", "encounter"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              Something you don't have now but would really like to own in the
              future
            </h1>

            <p className="text-lg font-bold">
              Describe something you don't have now but would really like to own
              in the future.
            </p>

            <p className="text-lg font-bold">You should say:</p>

            <li>What this thing is</li>
            <li>How long you have wanted to own it</li>
            <li>Where you first saw it</li>
          </ul>
...
export default Speaking4Part22015;
