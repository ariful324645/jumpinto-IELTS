            ...
            <div className="">
              ...
              <div className="flex items-center justify-center">
                <img
                  ...
                  src="https://i.ibb.co.com/7Jp6w20B/w2.jpg"
              ...
              {openScript ? (
                <div>
                  <h1 className="text-xl text-center  font-bold ">
                    Consumption of Fish and Meat in a European Country (1979 -
                    2004)
                  </h1>
                  <p className="mt-5">
                    ...
                    (6.51%), Ireland (6.43%), and Sweden (5.40%) - the lowest. <br /> <br />
                    In Leisure/Education, Turkey (4.35%) and Sweden (3.22%)
                    spent more, while Italy (3.20%) and Ireland (2.21%)
                    followed, with Spain having the smallest share at 1.98%.
...
export default Test2Writing2009;
