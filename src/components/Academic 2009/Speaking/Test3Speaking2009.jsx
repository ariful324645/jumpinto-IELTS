...
const questionKeywords = [
  ...
  ["how often", "cold weather", "season", "winter", "frequency", "why"],
  [
    "parts of country",
    "colder",
    "north",
  ...
  ["prefer", "hot place", "cold place", "comfort", "health", "why", "why not"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Cold weather</h1>
            <li>Have you ever been in very cold weather? [When?]</li>
            <li>How often is the weather cold where you come from?</li>
            <li>Are some parts of your country colder than others? [Why?]</li>
            <li>
...
export default Test3Speaking2009;
