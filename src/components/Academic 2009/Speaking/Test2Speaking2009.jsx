...
const questionKeywords = [
  ["make you laugh", "funny", "jokes", "comedy", "friends", "movies", "why"],
  ["making people laugh", "helpful", "fun", "personality", "why", "why not"],
  [
    "important",
    "laugh",
    "health",
  ...
  ["laughing", "happy", "same", "emotion", "feeling", "why", "why not"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Laughing</h1>
            <li>What kinds of thing make you laugh?</li>
            <li>Do you like making other people laugh? [Why/Why not?]</li>
            <li>
...
export default Test2Speaking2009;
