      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>How do you usually contact your friends? [Why?]</li>
            <li>
              Do you prefer to contact different people in different ways?
              [Why?]
            </li>
            ...
            <li>
              In your country, did people in the past keep in contact in the
              same ways as they do today? [Why/Why not?]
            </li>
          </ul>
        </div>
...
export default Test1Speaking2009;
