...
const questions = [
  ...
  "In some places people spend a lot of money on parties that celebrate special events. Is this ever true in your country? Do you think this is a good trend or a bad trend?",
...
const questionKeywords = [
  ...
  ["young people", "old people", "enjoy", "celebrations", "reason", "why"],
  [
    "waste of money",
    "government",
    "public money",
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Family parties & National celebrations
            </h1>

            <p className="text-lg font-bold">Family parties</p>
            <li>
              What are the main reasons why people organise family parties in
              your country?
            </li>
            <li>
              In some places people spend a lot of money on parties that
              celebrate special events. Is this ever true in your country? Do
              you think this is a good trend or a bad trend?
            </li>
            <li>
              Are there many differences between family parties and parties
              given by friends? Why do you think this is?
            </li>

            <p className="text-lg font-bold mt-4">National celebrations</p>
            <li>
              What kinds of national celebrations do you have in your country?
            </li>
            <li>
              Who tends to enjoy national celebrations more: young people or old
              people? Why?
            </li>
            <li>
              Why do you think some people think that national celebrations are
              a waste of government money? Would you agree or disagree with this
              view? Why?
            </li>
          </ul>
        </div>
...
export default Speaking1Part32009;
