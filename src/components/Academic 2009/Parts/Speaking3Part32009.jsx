...
import Speaking3Pagination2009 from "../Pagination 2009/Speaking3Pagination2009";

const Speaking3Part32009 = () => {
...
const questionKeywords = [
  ...
  ["prizes", "children", "school", "motivation", "reward", "good thing", "why"],
  ["schools", "children", "competitive", "more", "less", "past", "why"],
  [
    "advantages",
    "disadvantages",
    "intensive training",
  ...
  ["too competitive", "sport", "pressure", "stress", "negative effects", "why"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Competitions in school & Sporting competitions
            </h1>

            <p className="text-lg font-bold">Competitions in school</p>
            <li>
              Why do you think some school teachers use competitions as class
              activities?
            </li>
            <li>
              Do you think it is a good thing to give prizes to children who do
              well at school? Why?
            </li>
            <li>
              Would you say that schools for young children have become more or
              less competitive since you were that age? Why?
            </li>

            <p className="text-lg font-bold mt-4">Sporting competitions</p>
            <li>
              What are the advantages and disadvantages of intensive training
              for young sportspeople?
            </li>
            <li>
              Some people think that competition leads to better performance
              from sports stars. Others think it just makes players feel
              insecure. What is your opinion?
            </li>
            <li>
              Do you think it is possible to become too competitive in sport? In
              what way?
            </li>
          </ul>
        </div>
      ...
      <Speaking3Pagination2009></Speaking3Pagination2009>
    </div>
  );
};

export default Speaking3Part32009;
