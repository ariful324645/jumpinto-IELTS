...
const questions = [
  "What kind of competition it was and how did you find out about it?",
...
const questionKeywords = [
  ...
  ["had to do", "tasks", "rules", "participate", "performance", "challenge"],
  ["prizes", "reward", "money", "certificate", "gift", "award"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A competition that you took part in
            </h1>

            <p className="text-lg font-bold">
              Describe a competition (e.g. TV, college/work or sports
              competition) that you took part in.
            </p>
            ...
            <li>what you had to do</li>
            <li>what the prizes were</li>
          </ul>
...
export default Speaking3Part22009;
