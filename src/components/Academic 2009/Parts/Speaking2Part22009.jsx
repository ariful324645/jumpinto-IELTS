...
const questions = [
  "When and where did you have your idea?",
  "What was your idea?",
  "Who did you tell about your idea?",
];

const questionKeywords = [
  ["when", "where", "idea", "time", "place", "situation"],
  ["what idea", "plan", "concept", "solution", "thought"],
  ["who told", "friends", "family", "teacher", "colleagues", "shared"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <p className="text-lg font-bold">
              Describe an idea you had for improving something at work or
              college.
            </p>

            <p className="text-lg font-bold">You should say:</p>

            <li>when and where you had your idea</li>
            <li>what your idea was</li>
            <li>who you told about your idea</li>
          </ul>
...
export default Speaking2Part22009;
