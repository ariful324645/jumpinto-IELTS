...
import Speaking2Pagination2009 from "../Pagination 2009/Speaking2Pagination2009";

const Speaking2Part32009 = () => {
...
const questionKeywords = [
  ["education", "memorising", "ideas of the past", "agree", "disagree", "why"],
  ["education", "students", "new ideas", "creativity", "encourage", "why"],
  [
    "teachers",
    "help students",
    "develop ideas",
  ...
  ["employers", "workers", "new ideas", "improve company", "innovation", "why"],
  ["dislike new ideas", "change", "fear", "risk", "why"],
  [
    "having ideas",
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Ideas and education & Ideas in the workplace
            </h1>

            <p className="text-lg font-bold">Ideas and education</p>
            <li>
              Some people think that education should be about memorising the
            ...
            <p className="text-lg font-bold mt-4">Ideas in the workplace</p>
            <li>
      ...
      <Speaking2Pagination2009></Speaking2Pagination2009>
    </div>
  );
};

export default Speaking2Part32009;
