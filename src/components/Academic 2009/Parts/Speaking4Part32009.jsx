...
const questionKeywords = [
  ...
  ["new homes", "equipped", "future", "technology", "yes or no", "why"],
  [
    "equipment",
    "workers",
    "offices",
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Technology and housework & Technology in the workplace
            </h1>

            <p className="text-lg font-bold">Technology and housework</p>
            <li>
              What kinds of machine are used for housework in modern homes in
              your country?
            </li>
            <li>
            ...
            <li>
              What kinds of equipment do most workers need to use in offices
              today?
            </li>
            <li>
            ...
            <li>
              Some people think that technology has brought more stress than
...
export default Speaking4Part32009;
