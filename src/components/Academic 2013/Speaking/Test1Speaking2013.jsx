...
const questionKeywords = [
  ...
  ["play games", "yes", "no", "free time", "enjoy", "stress", "why", "why not"],
  [
    "learn games",
    "friends",
    "family",
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>What games are popular in your country? [Why?]</li>
            <li>Do you play any games? [Why/Why not?]</li>
            <li>How do people learn to play games in your country?</li>
            <li>
              Do you think it's important for people to play games? [Why/Why
              not?]
            </li>
          </ul>
        </div>
