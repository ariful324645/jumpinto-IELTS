      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Giving gifts</h1>
            <li>When do people give gifts or presents in your country?</li>
            <li>
              Do you ever take a gift when you visit someone in their home?
              [Why/Why not?]
            </li>
            <li>When did you last receive a gift? [What was it?]</li>
            <li>Do you enjoy looking for gifts for people? [Why/Why not?]</li>
          </ul>
        </div>
