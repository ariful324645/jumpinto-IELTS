...
const Listening2Part32011 = () => {
  ...
  // different option
const questions = [
  "In order to set up her research programme, Shona got",
  ...
  "Shona has learnt from the research project that",
];
...
const correctAnswers = {
  ...
  34: "A. Current concerns are misrepresented by the press.",
  35: "C. identify the preferences of the public.",
...
const lines = [
  {
    speaker: "ANNOUNCER",
    text: [
      "Section 4, you will hear a student called Shona giving a presentation on her research report.",
...

  {
    ...
    text: [
      ...
      "Now I had to set up my program of research in three different countries.",
      {
        text: "So I approached postgraduates in my field in overseas departments, contacting them by email to organize things for me at their end.",
        number: 31,
      },
      ...
      {
        text: "I decided that people under 18 should be excluded, and at this stage just to focus on men who were in employment.",
        number: 32,
      },
      {
        text: "I specifically wanted to do a questionnaire and include as much variety as possible.",
        number: 33,
      },
      "I know questionnaires are a very controlled way to do things, but I thought I could do taped interviews later on.",
      {
        text: "At the moment it looks as if in the UK, it is mainly hospital care that people are worried about, rather than general practice.",
        number: 34,
      },
      "Government reforms have been proposed at all levels, although their success is not guaranteed.",
      {
        text: "I will need to do more far-reaching research to establish whether people want extra medical staff in the community or fewer but larger medical units.",
        number: 35,
      },
      "This first stage has proved very valuable though.",
      {
        text: "I was concerned that something I thought I'd set up well didn't necessarily seem that way to everyone in my own department.",
        number: 36,
      },
      "I thought you might also be interested in some of the problems I encountered in collecting my data.",
      {
        text: "One subject I approached in the street decided to pull out at the second round.",
        number: 37,
      },
      {
        text: "One undergraduate wanted reassurance that no names would be traceable from the answers.",
        number: 38,
      },
      {
        text: "One colleague kept changing his mind about participating, but in the end he did take part.",
        number: 39,
      },
      {
        text: "A tutor at a university in France refused to tell me exactly what his work involved.",
        number: 40,
      },
      ...
      <div className="flex gap-6 h-[1000px]">
          ...
          {openScript ? (
            <div className="space-y-5">
              <h1 className="text-2xl font-bold mb-8 text-center">
                {renderText(
                  "Research on Public Perception of General Practitioners",
                )}
              </h1>
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll pb-10">
          ...
          <div>
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <h3 className="text-lg mb-5">
                ...
                {renderText("next to Questions 37-40.")}
              </h3>
              <div className="flex items-center justify-center border border-black py-4 px-4 w-72 mx-auto">
                <div className="text-center">
                  ...
                  <ul className="space-y-1 text-lg">
                    <li>{renderText("A. gave false data")}</li>
                    <li>{renderText("B. decided to stop participating")}</li>
                    <li>
                      {renderText("C. refused to tell Shona about their job")}
                    </li>
                    <li>
                      {renderText(
                    ...
                    <li>{renderText("E. became very angry with Shona")}</li>
                    <li>
                      {renderText("F. was worried about confidentiality")}
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="space-y-2">
            <h1 className="text-lg font-bold">People interviewed by Shona</h1>

            {/* ---------- Question 37 ---------- */}
            <p className="flex items-center gap-2 flex-wrap">
              <span className="font-bold text-lg">{renderText("37.")}</span>
              <span>{renderText("a person interviewed in the street")}</span>
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              <span>{renderText("an undergraduate at the university")}</span>
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              <span>{renderText("a colleague in her department")}</span>
            ...
            <p className="flex items-center gap-2 flex-wrap">
              ...
              <span>{renderText("a tutor in a foreign university")}</span>
