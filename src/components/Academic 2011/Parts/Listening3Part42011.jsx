...
const Listening3Part42011 = () => {
  ...
  const questions = [
    "Compared to introducing new business processes, attempts to copy existing processes are",
...
const correctAnswers = {
  31: "B. more frequent",
  32: "C. related to only a few contexts.",
...
const lines = [
  {
    speaker: "ANNOUNCER",
    text: [
      "Section 4, you will hear a lecture about success in business systems.",
...

  {
    ...
    text: [
      ...
      {
        text: "It's a less glamorous activity than pure innovation, but it actually happens more often as a matter of fact.",
        number: 31,
      },
      "However surprisingly getting things right the second time is not necessarily any simpler than it was the first time.",
      "There's been a lot of research into how companies can repeat their previous successes.",
      "And it certainly hasn't been confined to the United States.",
      "It has been shown that the overwhelming majority of attempts fail.",
      {
        text: "A host of studies confirm this, covering a wide range of business settings, branch banks, retail stores, real estate agencies, factories, call centers, to name but a few.",
        number: 32,
      },
      "So why do so few managers get things right the second or third time?",
      "Placing too much trust in the experts is one reason.",
      "Managers often go to the person who designed and is running a successful system and ask for advice.",
      {
        text: "This approach works only for gaining a rough understanding because even experts do not fully understand complex systems.",
        number: 33,
      },
      "The expert never has complete access to all necessary information.",
      "Some details are invisible or difficult to describe.",
      {
        text: "Many details are learned on the job and are impossible to communicate clearly.",
        number: 34,
      },
      "Now let's consider two types of mistake that occur when copying a successful process.",
      "First, a manager may try to improve the process instead of copying it exactly.",
      "Another mistake is combining the best parts of different systems to create a perfect model.",
      {
        text: "Unfortunately, these attempts usually fail because advantages may be based on inaccurate information or incomparable business settings.",
        number: 35,
      },
      "More typically, real advantages exist but hidden disadvantages are overlooked.",
      {
        text: "For example, modifications might compromise safety or other important factors.",
        number: 36,
      },
      "So what's the solution?",
      "The problem is more about attitude than difficulty.",
      "Managers need to be realistic and cautious.",
      {
        text: "They should impose strict controls and copy the original system as closely as possible.",
        number: 37,
      },
      {
        text: "Not only duplicating physical features but also duplicating the skills of the original employees.",
        number: 38,
      },
      {
        text: "Reliance on a detailed template ensures consistency across the organization.",
        number: 39,
      },
      {
        text: "This approach preserves the knowledge embedded in the original system and its workforce.",
        number: 40,
      },
    ],
  },
      ...
      <div className="flex gap-6 h-[1000px]">
          ...
          {openScript ? (
            <div className="space-y-5">
              <h1 className="text-2xl font-bold mb-8 text-center">
                {renderText("Challenges in Replicating Business Successes")}
              </h1>
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll pb-10">
          ...
          <div className="border p-6 rounded-lg space-y-5 bg-white">
            <h1 className="text-2xl font-bold text-center">
              {renderText("Setting up systems based on an existing process")}
            </h1>

            {/* Two Mistakes */}
            <p className="text-lg font-bold">
              {renderText("Two mistakes - Manager tries to:")}
            </p>

            <ul className="text-lg space-y-2">
              <li>{renderText("• improve on the original process")}</li>
              <li>{renderText("• create an ideal")}</li>
              ...
              <li className="flex items-center">
                ...
                />
                {renderText("from the best parts of several processes")}
              </li>
            </ul>

            {/* Cause of Problems */}
            <p className="text-lg font-bold">
              {renderText("Cause of problems")}
            </p>

            <ul className="text-lg space-y-2">
              <li>{renderText("• information was inaccurate")}</li>
              <li>
                {renderText(
            ...
            {/* Solution */}
            <p className="text-lg font-bold">{renderText("Solution")}</p>
            ...
            <p className="text-lg flex items-center">
              {renderText(
                "copy original very closely: physical features of the",
              )}
              <button
            ...
            <p className="text-lg flex items-center">
              ...
              <input
                ...
                className="border rounded-md px-2 py-1 w-32 mx-2"
              />
              {renderText("of original employees")}
            </p>
          </div>
...
export default Listening3Part42011;
