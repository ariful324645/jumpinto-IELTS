...
const questionKeywords = [
  ["who", "person", "who was", "identity", "name"],
  ["family", "knew", "relationship", "connection", "how"],
  ["how often", "visited", "family", "frequency", "times"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A friend of your family you remember from your childhood
            </h1>
            ...
            <li>how your family knew this person</li>
            <li>how often this person visited your family</li>
          </ul>
...
export default Speaking4Part22011;
