...
const questions = [
  ...
  "What type of food did you eat in this restaurant?",
];

const questionKeywords = [
  ["where", "restaurant", "location", "place", "area", "city"],
  ["why", "choose", "restaurant", "reason", "popular", "recommend"],
  ["type", "food", "ate", "restaurant", "meal", "cuisine"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A restaurant that you enjoyed going to
            </h1>
            ...
            <li>why you chose this restaurant</li>
...
export default Speaking2Part22011;
