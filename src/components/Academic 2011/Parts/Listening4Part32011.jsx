...
const questions = [
  "In which way is Dan financing his course?",
  "In which way is Dan financing his course?",
  "Why does Jeannie decide to leave some college clubs?",
  "Why does Jeannie decide to leave some college clubs?",
...
const options = [
  ...
  [
    "A. His local council is supporting him for a limited period.",
    "B. A former employer is providing partial funding.",
    "C. He is receiving money from the government.",
  ],
  [
  ...
  [
    "A. The activity is too demanding physically.",
    "B. She does not think she is any good at the activity.",
    "C. She is not sufficiently challenged.",
  ],
  [
 ...
 const correctAnswers = {
   21: "B. His family are willing to help him.",
   22: "B. A former employer is providing partial funding.",
   23: "C. She does not have enough time.",
   24: "A. The activity is too demanding physically.",
   25: "B. The seminars make him feel inferior to the other students.",
   26: "C. They are helping her to develop her study skills.",
   27: "priorities",
   28: "revision timetable",
   29: "small daily tasks",
   30: "short paragraph",
 };
...
const lines = [
  {
    speaker: "ANNOUNCER",
    text: [
      "Section 3. You will hear two students called Dan and Jeannie discussing their studies at university.",
...

  {
    ...
    text: [
      ...
      "It was practically a year ago that I applied to my local council for a grant, and it took them 6 months to turn me down.",
      "I thought I was eligible for government funding, but it seems I was mistaken.",
      "So then I asked the boss of the company I used to work for if they would sponsor me, and he agreed to make a contribution.",
      {
        text: "My family decided to help me financially, so now I've just about got enough money.",
        number: 21,
      },
      {
        text: "My former employer agreed to provide partial funding for my course.",
        number: 22,
      },
    ],
  },

  {
    speaker: "JEANNIE",
    text: [
      "What about college grants and scholarships? There must be some you could apply for.",
      "Yes, there are, but they're small so I left them for later.",
      "I joined several college clubs.",
      "I'm in the drama club and we're rehearsing for our first performance.",
      {
        text: "I will leave the singing group because it does not challenge me enough.",
        number: 23,
      },
      {
        text: "I am also leaving the debating society because I do not have enough time.",
        number: 24,
      },
    ],
  },

  {
    ...
    text: [
      ...
      {
        text: "I feel intimidated in seminars because other students speak confidently and I doubt my ability.",
        number: 25,
      },
    ],
  },

  {
    ...
    text: [
      {
        text: "My tutorials are helping me develop better study skills because my tutor gives detailed feedback and guidance.",
        number: 26,
      },
    ],
  },
...

  {
    speaker: "JEANNIE",
    text: [
      "First, find out exactly what is required in the exams.",
      "Get hold of some past papers to understand the requirements clearly.",
      {
        text: "Write your revision priorities on a card and read them regularly.",
        number: 27,
      },
      {
        text: "Make a revision timetable and keep it visible while studying.",
        number: 28,
      },
      {
        text: "Divide revision into small daily tasks to avoid procrastination.",
        number: 29,
      },
      {
        text: "Write one short paragraph about each topic while revising.",
        number: 30,
      },
      "Then practise writing exam answers for better preparation.",
    ],
  },
          ...
          {openScript ? (
            <div className="space-y-5">
              <h1 className="text-2xl font-bold mb-8 text-center">
                {renderText("College Life and Studies Discussion")}
              </h1>
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll pb-10">
          ...
          <div className="space-y-6 leading-relaxed p-4">
            ...
            <h1 className="text-2xl font-bold text-center">
              {renderText("  Trying to repeat success")}
            </h1>
          ...
          <div className="border p-6 rounded-lg space-y-5 bg-white">
            <h1 className="text-2xl font-bold text-center">
              {renderText("Advice on exam preparation")}
            </h1>

            <p className="text-lg text-center">↓</p>

            <p className="text-lg text-center">
              {renderText("Make sure you know the exam requirements")}
            </p>

            <p className="text-lg text-center">↓</p>

            <p className="text-lg text-center">
              {renderText("Find some past papers")}
            </p>

            <p className="text-lg flex items-center justify-center gap-2">
              {renderText("Work out your")}
              <button
              ...
              />
              {renderText("for revision and write them on a card")}
            </p>
            ...
            <p className="text-lg flex items-center justify-center gap-2">
              ...
              <input
                ...
                className="border rounded-md px-2 py-1 w-32"
              />
              {renderText("and keep it in view")}
            </p>

            <p className="text-lg text-center">↓</p>

            <p className="text-lg flex items-center justify-center gap-2">
              {renderText("Divide revision into")}
              <button
              ...
              <input
                ...
                className="border rounded-md px-2 py-1 w-32"
              />
              {renderText("for each day")}
            </p>

            <p className="text-lg text-center">↓</p>

            <p className="text-lg flex items-center justify-center gap-2">
              {renderText("Write one")}
              <button
              ...
              <input
                ...
                className="border rounded-md px-2 py-1 w-32"
              />
              {renderText("about each topic")}
            </p>

            <p className="text-lg text-center">↓</p>

            <p className="text-lg text-center">
              {renderText("Practise writing some exam answers")}
            </p>
          </div>
...
export default Listening4Part32011;
