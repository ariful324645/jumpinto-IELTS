...
const questions = [
  ...
  "What opinions did you give in the survey?",
];

const questionKeywords = [
  ["what", "questionnaire", "survey", "about", "topic", "purpose"],
  ["why", "asked", "opinions", "reason", "participate"],
  ["what", "opinions", "gave", "feedback", "thoughts", "answers"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A time when you were asked to give your opinion in a questionnaire
              or survey
            </h1>
            ...
            <li>what the questionnaire or survey was about</li>
            <li>why you were asked to give your opinions</li>
            <li>what opinions you gave</li>
          </ul>
...
export default Speaking1Part22011;
