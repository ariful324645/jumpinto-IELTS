...
const questionKeywords = [
  ["magazines", "newspapers", "read", "why", "types"],
  ["articles", "interested", "topics", "why", "preferences"],
  ["foreign language", "read", "newspaper", "magazine", "when", "why"],
  ["good way", "learn", "language", "reading", "foreign language"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>Which magazines and newspapers do you read?</li>
            <li>What kinds of article are you most interested in? </li>
            <li>
              Have you ever read a newspaper or magazine in a foreign language?
              [When/Why?]
            </li>
            <li>
              ...
              is a good way to learn the language?
            </li>
          </ul>
        </div>
...
export default Test2Speaking2011;
