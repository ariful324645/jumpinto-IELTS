...
const questionKeywords = [
  ["flowers", "home", "like", "why", "why not"],
  ["buy", "flowers", "where", "shop", "market"],
  ["occasions", "give", "flowers", "celebrations", "events"],
  ["important", "culture", "flowers", "tradition", "why", "why not"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Flowers</h1>
            <li>Do you like to have flowers in your home? [Why/Why not?]</li>
            <li>Where would you go to buy flowers? [Why?]</li>
            <li>On what occasions would you give someone flowers?</li>
            <li>Are flowers important in your culture? [Why/Why not?]</li>
          </ul>
        </div>
...
export default Test3Speaking2011;
