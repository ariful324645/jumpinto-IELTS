...
const questionKeywords = [
  ["how often", "watch", "television", "why", "why not"],
  ["television channel", "usually", "watch", "why", "favourite"],
  ["advertisements", "television", "enjoy", "why", "why not"],
  ["programmes", "television", "good", "why", "why not"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Television</h1>
            <li>How often do you watch television? [Why/Why not?]</li>
            <li>Which television channel do you usually watch? [Why?]</li>
            <li>
              Do you enjoy the advertisements on television? [Why/Why not?]
            </li>
            <li>
              Do you think most programmes on television are good? [Why/Why
              not?]
            </li>
          </ul>
        </div>
...
export default Test4Speaking2011;
