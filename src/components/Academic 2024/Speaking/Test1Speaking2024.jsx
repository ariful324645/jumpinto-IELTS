...
const questionKeywords = [
  ...
  ["often", "eat", "foreign", "other countries", "food", "frequency"],
  ["tried", "making", "cook", "another country", "food", "recipe"],
  ["recommend", "your country", "food", "people", "foreigners", "traditional"],
];
    ...
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">International food</h2>
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>
              How often do you eat typical food from other countries? Why or why
              not?
            </li>
            <li>
              Have you ever tried making food from another country? Why or why
              not?
            </li>
            <li>
              What food from your country would you recommend to people from
              other countries? Why?
            </li>
          </ul>
        </div>
...
export default Test1Speaking2024;
