...
const questions = [
  "Have you travelled a lot by plane? ",
  "Why do you think some people enjoy travelling by plane?",
  "Would you like to live near an airport? ",
  "In the future, do you think that you will travel by plane more often?",
];

const questionKeywords = [
  ["travelled", "plane", "flight", "where", "experience"],
  ["people", "enjoy", "travelling", "plane", "reason"],
  ["live", "near", "airport", "noise", "convenience"],
  ["future", "travel", "plane", "more often", "reason"],
];
    ...
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">Travelling by plane</h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>Have you travelled a lot by plane? To where or why not?</li>
            <li>Why do you think some people enjoy travelling by plane?</li>
            <li>Would you like to live near an airport? Why or why not?</li>
            <li>
              In the future, do you think that you will travel by plane more
...
export default Test2Speaking2024;
