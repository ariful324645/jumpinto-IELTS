...
const questions = [
  "Who is this person?",
  "Which prize, award or medal did they receive?",
  "What did they do to win this?",
];

const questionKeywords = [
  ["who", "person", "identity", "name", "background"],
  ["prize", "award", "medal", "recognition", "honour"],
  ["what", "did", "to win", "achievement", "contribution"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <p className="text-lg font-bold">
              Describe a person from your country who has won a prize, award or
              medal.
            </p>
          ...
          <p className="text-lg font-bold mt-3">
            and explain whether you think it was right that this person received
            this prize, award or medal.
          </p>
        </div>
...
export default Speaking2Part22024;
