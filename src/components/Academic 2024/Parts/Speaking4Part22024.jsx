...
const questions = [
  ...
  "What views can you see from this place?",
];

const questionKeywords = [
  ["where", "place", "location", "area"],
  ["when", "why", "visited", "time", "reason"],
  ["views", "see", "scenery", "surroundings", "landscape"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A place you visited that has beautiful views
            </h1>
            ...
            <li>what views you can see from this place</li>
          </ul>
...
export default Speaking4Part22024;
