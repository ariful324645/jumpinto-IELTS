...
const questionKeywords = [
  ["beauty products", "waste of money", "agree", "opinion"],
  ["beauty industry", "advertise", "marketing", "successful"],
  ["advertised", "children", "beauty products", "view", "ethics"],
  ["heading", "beauty", "culture"],
  ["youth", "beauty", "equate", "reason"],
  ["beautiful", "success", "life", "advantages", "opinion"],
  ["society", "ideas", "beauty", "change", "time"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              The beauty industry & Beauty and culture
            </h1>

            <p className="text-lg font-bold">The beauty industry</p>
            <li>
              Do you agree that most beauty products are a waste of money?
            </li>
            <li>
              How does the beauty industry advertise its products so
              successfully?
            </li>
            <li>
              What do you think of the view that beauty products should not be
              advertised to children?
            </li>

            <p className="text-lg font-bold mt-4">Beauty and culture</p>
            <li>Why do many people equate youth with beauty?</li>
            <li>
              Do you think that being beautiful could affect a person's success
              in life?
            </li>
            <li>Why might society's ideas about beauty change over time?</li>
          </ul>
        </div>
...
export default Speaking4Part32024;
