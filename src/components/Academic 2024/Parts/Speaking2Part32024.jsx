...
import Speaking2Pagination2024 from "../Pagination 2024/Speaking2Pagination2024";
...
const questionKeywords = [
  ["school", "prizes", "children", "awards", "types"],
  ["advantages", "rewarding", "schoolchildren", "good work", "benefits"],
  ["parents", "teachers", "rewards", "importance", "children"],
  ["heading", "sportspeople", "rewards"],
  ["sportspeople", "paid", "money", "footballers", "salary"],
  ["team", "prize money", "win", "everyone", "fairness"],
  ["sport", "participation", "winning", "importance", "view"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Rewards for children at school & Rewards for sportspeople
            </h1>

            <p className="text-lg font-bold">Rewards for children at school</p>
            <li>
              What types of school prizes do children in your country receive?
            </li>
            <li>
              What do you think are the advantages of rewarding schoolchildren
              for good work?
            </li>
            <li>
              Do you agree that it's more important for children to receive
              rewards from their parents than from teachers?
            </li>

            <p className="text-lg font-bold mt-4">Rewards for sportspeople</p>
            <li>
              Do you think that some sportspeople (e.g., top footballers) are
              paid too much money?
            </li>
            <li>
              Should everyone on a team get the same prize money when they win?
            ...
            <li>
              Do you agree with the view that, in sport, taking part is more
      ...
      <Speaking2Pagination2024></Speaking2Pagination2024>
    </div>
  );
};
