...
const questionKeywords = [
  ["law", "rule", "regulation", "policy"],
  ["who", "introduced", "government", "authority"],
  ["when", "why", "introduced", "reason", "time"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A law that was introduced in your country and that you thought was
              a very good idea
            </h1>

            <p className="text-lg font-bold">
              Describe a law that was introduced in your country and that you
...
export default Speaking1Part22024;
