...
import Speaking3Pagination2024 from "../Pagination 2024/Speaking3Pagination2024";

const Speaking3Part32024 = () => {
...
const questionKeywords = [
  ["young people", "interested", "learning to drive", "driving"],
  ["differences", "driving", "countryside", "city", "traffic"],
  ["drivers", "good drivers", "behaviour", "road safety"],
  ["heading", "electric cars", "EV"],
  ["popular", "electric cars", "country", "demand"],
  ["persuaded", "buy", "electric cars", "incentives", "government"],
  ["future", "all cars", "electric", "one day", "prediction"],
];
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Driving a car & Electric cars
            </h1>

            <p className="text-lg font-bold">Driving a car</p>
            <li>
              How interested are young people in your country in learning to
              drive?
            </li>
            <li>
              What are the differences between driving in the countryside and
              driving in the city?
            </li>
            <li>
              Do you consider most drivers where you live to be good drivers?
            ...
            <p className="text-lg font-bold mt-4">Electric cars</p>
            <li>How popular are electric cars in your country?</li>
            <li>
              In what ways could more people be persuaded to buy electric cars?
            </li>
            <li>Do you think all cars will be electric one day?</li>
          </ul>
        </div>
      ...
      <Speaking3Pagination2024></Speaking3Pagination2024>
    </div>
  );
};

export default Speaking3Part32024;
