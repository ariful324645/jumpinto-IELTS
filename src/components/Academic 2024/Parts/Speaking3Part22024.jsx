...
const questionKeywords = [
  ["where", "going", "destination", "place"],
  ["who", "with", "company", "friends", "family"],
  ["felt", "journey", "during", "emotion", "experience"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A car journey you made that took longer than expected
            </h1>
            ...
            <li>where you were going</li>
            <li>who you were with</li>
            <li>how you felt during the journey</li>
          </ul>
...
export default Speaking3Part22024;
