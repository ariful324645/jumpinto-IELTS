      ...
      <div className="flex gap-6 h-[1000px]">
        ...
        <div className="md:w-[72%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll h-[90vh]">
          ...
          <div className="mt-5">
            ...
            <table className=" w- border-collapse border border-gray-400 w-full text-center">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 p-2">
                    {" "}
                    <h3 className=" text-lg ">
                      <span className=" inline-block">Re-stock with</span>
                      <button
                ...
                <tr>
                  ...
                  <td className="border border-gray-400 p-2">
                    {" "}
                    <h3 className=" text-lg ">
                      <span className=" inline-block">Must wear special</span>
                      <button
                      ...
                      <input
                        className="ml-3 border-2 border-gray-300 focus:border-blue-400 focus:outline-none rounded-md  py-1"
                        type="text"
                        placeholder=""
                      />
                    </h3>
