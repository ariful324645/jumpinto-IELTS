  ...
  const lines = [
    {
      speaker: "ANNOUNCER",
      text: [
        "Part 4. You will hear part of a lecture on the early history of keeping clean.",
    ...
    },
    {
      ...
      text: [
        ...
        {
          text: "At least that it rinsed MUD off their hands.",
          number: 31,
        },
        "During the excavation of ancient Babylon, evidence was found that soap making was known.",

        {
          text: "As early as 2800 BC, archaeologists discovered cylinders made of clay with inscriptions on them saying that fats were boiled with ashes.",
          number: 32,
        },
        ...
        {
          text: "Then anointed themselves with oil, and scraped off the oil and dirt with a metal instrument known as a strigil.",
          number: 33,
        },
        ...
        "As Roman civilization advanced, so did bathing.",
        ...
        {
          text: "This lack of personal cleanliness and related unsanitary living conditions were major factors in the outbreaks of disease in the Middle Ages.",
          number: 36,
        },
        "And especially the Black Death of the 14th century.",
        "Nevertheless, soap making became an established craft in Europe, and associations of soap makers guarded their trade secrets closely.",
        {
        ...
        {
          text: "A major step toward large scale commercial soap making occurred in 1791 when a French chemist Nicholas LeBlanc patented a process for turning salt into soda ash, or sodium carbonate.",
          number: 38,
        },
        ...
        "Modern soap making was born some 20 years later, in the early 19th century, with the discovery by Michel Eugène Chevreul, another French chemist, of the chemical nature and relationship of fats, glycerin, and fatty acids.",
        "His studies established the basis for both fat and soap chemistry.",
        {
          text: "And soap making became a science.",
          number: 39,
        },
        ...
        {
          text: "A development that was reinforced when the high tax was removed.",
          number: 40,
        },
...
const correctAnswers = {
  ...
  const calculateScore = (answers) => {
    ...
    setScore(newScore);
    localStorage.setItem("/listening3Part42020", newScore);
  };
  ...
  const handleClear = () => {
    ...
    setActiveButtons({});
    setIsOpen(false);
    localStorage.removeItem("/listening3Part42020");
  };

  // --- Restore answers from localStorage (optional) ---
  useEffect(() => {
    const savedScore = localStorage.getItem("/listening3Part42020");
    if (savedScore) {
      ...
      <div className="flex gap-6 h-[1000px]">
          ...
          {openScript ? (
            <div className="space-y-5">
              <h1 className="text-2xl font-bold mb-8 text-center">
                {renderText("Early history of keeping clean")}
              </h1>
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll pb-10">
          ...
          <div className="overflow-x-auto border p-5 bg-white rounded-lg">
            ...
            {/* ---------- Section 1: Prehistoric times ---------- */}
            <ul className="list-disc list-inside space-y-3">
              <li className="text-lg">
                <span>{renderText("Water was used to wash off")}</span>
                <button
            ...
            {/* ---------- Section 2: Ancient Babylon ---------- */}
            <h2 className="text-lg font-bold mt-6">
              {renderText("Ancient Babylon")}
            </h2>
            <ul className="list-disc list-inside space-y-3">
              <li className="text-lg">
                <span>{renderText("Soap-like material found in")}</span>
                <button
                ...
                <input
                  ...
                  type="text"
                />
                <span>{renderText("cylinders.")}</span>
              </li>
            </ul>

            {/* ---------- Section 3: Ancient Greece ---------- */}
            <h2 className="text-lg font-bold mt-6">
              {renderText("Ancient Greece")}
            </h2>
            <ul className="list-disc list-inside space-y-3">
              <li className="text-lg">
                {renderText(
              ...
              <li className="text-lg">
                <span>{renderText("Used a strigil - scraper made of")}</span>
                <button
              ...
              <li className="text-lg">
                {renderText("Washed clothes in streams")}
              </li>
            </ul>

            {/* ---------- Section 4: Ancient Germany and Gaul ---------- */}
            <h2 className="text-lg font-bold mt-6">
              {renderText("Ancient Germany and Gaul")}
            </h2>
            <ul className="list-disc list-inside space-y-3">
              <li className="text-lg">
                <span>{renderText("Used soap to colour their")}</span>
                <button
            ...
            <ul className="list-disc list-inside space-y-3">
              ...
              <li className="text-lg">
                <span>
                  {renderText("From about 312 BC, water carried to Roman")}
                </span>
                <button
                ...
                <input
                  ...
                  type="text"
                />
                <span>{renderText("by aqueducts.")}</span>
              </li>
            </ul>

            {/* ---------- Section 6: Europe in Middle Ages ---------- */}
            <h2 className="text-lg font-bold mt-6">
              {renderText("Europe in Middle Ages")}
            </h2>
            <ul className="list-disc list-inside space-y-3">
              <li className="text-lg">
                <span>
              ...
              <li className="text-lg">
                <span>{renderText("Ingredient added to soap:")}</span>
                <button
            ...
            {/* ---------- Section 7: Europe 17th-19th century ---------- */}
            <h2 className="text-lg font-bold mt-6">
              {renderText("Europe from 17th century")}
            </h2>
            <ul className="list-disc list-inside space-y-3">
              <li className="text-lg">
                <span>
              ...
              <li className="text-lg">
                <span>
                  {renderText("Early 1800s: Chevreul turned soapmaking into a")}
                </span>
                <button
              ...
              <li className="text-lg">
                <span>{renderText("From 1800s, there was no longer a")}</span>
                <button
...
export default Listening3Part42020;
