      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>How often do you go out with friends? [Why/Why not?]</li>
            <li>Tell me about your best friend at school.</li>
            <li>How friendly are you with your neighbours? [Why/Why not?]</li>
            <li>Which is more important to you, friends or family? [Why?]</li>
          </ul>
        </div>
...
export default Test2Speaking2016;
