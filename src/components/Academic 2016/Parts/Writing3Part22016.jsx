...
import Writing3Pagination2016 from "../Pagination2016/Writing3Pagination2016";

const Writing3Part22016 = () => {
  ...
  return (
    <div className="px-3">
            ...
            {openScript ? (
              <div>
                ...
                <p className="mt-5">
                  ...
                  require local language skills to deliver effective care. <br /> <br />
                  ...
                  delaying age-related cognitive decline. <br /> <br /> The mental exercise of
                  switching between grammatical structures enhances multitasking
                  abilities, benefiting learners regardless of their travel
                  plans. Culturally, language mastery grants access to literary
                  treasures in their original form - reading Gabriel García
                  Márquez in Spanish or Haruki Murakami in Japanese offers
                  nuances lost in translation. Moreover, language learning
                  fosters empathy by exposing students to alternative
                  worldviews, as demonstrated by Scandinavian schools
                  incorporating Arabic studies to combat cultural prejudice. <br /> <br />
      ...
      <Writing3Pagination2016></Writing3Pagination2016>
    </div>
  );
};

export default Writing3Part22016;
