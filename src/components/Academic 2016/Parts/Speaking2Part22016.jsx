...
const questions = [
  ...
  "What you would like to find out about him or her",
];

const questionKeywords = [
  ["who", "writer", "author", "person"],
  ["know", "already", "writer", "background", "works"],
  ["would like", "find out", "writer", "life", "career"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>Who the writer is</li>
            <li>What you already know about this writer</li>
            <li>What you would like to find out about him or her</li>
          </ul>
...
export default Speaking2Part22016;
