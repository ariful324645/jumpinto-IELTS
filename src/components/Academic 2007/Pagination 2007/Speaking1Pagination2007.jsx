...
const Speaking1Pagination2007 = () => {
  ...
  const topicLinks = {
    Listening: "/2007/Test%201/listening",
    Reading:   "/2007/Test%201/reading",
    Writing:   "/2007/Test%201/writing",
    Speaking:  "/2007/Test%201/speaking",
  };
  ...
  const centerLinks = [
    "/2007/Test%201/speaking",

    "/speaking1Part22007", // page 2
    "/speaking1Part32007", // page 2
  ];
...
export default Speaking1Pagination2007;
