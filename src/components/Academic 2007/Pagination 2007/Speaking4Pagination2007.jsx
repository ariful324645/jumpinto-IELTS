...
const Speaking4Pagination2007 = () => {
  ...
  const topicLinks = {
    Listening: "/2007/Test%204/listening",
    Reading:   "/2007/Test%204/reading",
    Writing:   "/2007/Test%204/writing",
    Speaking:  "/2007/Test%204/speaking",
  };
  ...
  const centerLinks = [
    "/2007/Test%204/speaking",

    "/speaking4Part22007", // page 2
    "/speaking4Part32007", // page 2
  ];
...
export default Speaking4Pagination2007;
