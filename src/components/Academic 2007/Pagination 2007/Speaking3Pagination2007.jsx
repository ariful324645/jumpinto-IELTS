...
const Speaking3Pagination2007 = () => {
  ...
  const topicLinks = {
    Listening: "/2007/Test%203/listening",
    Reading:   "/2007/Test%203/reading",
    Writing:   "/2007/Test%203/writing",
    Speaking:  "/2007/Test%203/speaking",
  };
  ...
  const centerLinks = [
    "/2007/Test%203/speaking",

    "/speaking3Part22007", // page 2
    "/speaking3Part32007", // page 2
  ];
...
export default Speaking3Pagination2007;
