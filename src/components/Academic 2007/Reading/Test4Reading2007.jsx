...
const correctAnswers = {
  ...
  1: "i", // Paragraph A → Not all doctors are persuaded
  2: "vii", // Paragraph B → Research shows that promotion works
  3: "v", // Paragraph C → An example of what doctors expect from drug companies
  4: "ix", // Paragraph D → The positive side of drugs promotion
  5: "ii", // Paragraph E → Choosing the best offers
  6: "viii", // Paragraph F → The high costs of research
  7: "x", // Paragraph G → Who really pays for doctors' free gifts?

  // Questions 8–13 (YES / NO / NOT GIVEN)
  8: "NOT GIVEN", // Sales representatives like Kim Schaefer work to a very limited budget
  9: "YES", // Kim Schaefer's marketing technique may be open to criticism on moral grounds
  10: "NO", // The information provided by drug companies is of little use to doctors
  11: "YES", // Evidence of drug promotion is clearly visible in the healthcare environment
  12: "NOT GIVEN", // The drug companies may give free drug samples to patients without doctors' prescriptions
  13: "YES", // It is legitimate for drug companies to make money
};
      ...
      <div className="flex gap-6 h-[1000px]">
        ...
        <div className="md:w-[50%] bg-white rounded-lg shadow-md p-4 overflow-y-scroll pb-10">
          ...
          <div className="space-y-4">
            ...
            <p>
              {renderText(
                "Choose the correct number, i-x, in boxes 1-7 on your answer sheet.",
              )}
            </p>
            ...
            <div className="flex items-center justify-center border border-black py-4 px-6 w-96 mx-auto">
              <div className="text-left">
                ...
                <ul className="space-y-1 text-lg">
                  <li>{renderText("i. Not all doctors are persuaded")}</li>
                  <li>{renderText("ii. Choosing the best offers")}</li>
                  <li>
                    {renderText(
                      "iii. Who is responsible for the increase in promotions?",
                    )}
                  </li>
                  <li>{renderText("iv. Fighting the drug companies")}</li>
                  <li>
                    {renderText(
                  ...
                  <li>
                    {renderText("vi. Gifts include financial incentives")}
                  </li>
                  <li>
                    {renderText("vii. Research shows that promotion works")}
                  </li>
                  <li>{renderText("viii. The high costs of research")}</li>
                  <li>
                    {renderText("ix. The positive side of drugs promotion")}
                  </li>
                  <li>
                    {renderText("x. Who really pays for doctors' free gifts?")}
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-2 border-black rounded-lg p-5 mt-5 space-y-4">
              {[...Array(7)].map((_, idx) => (
                <div className="flex items-center gap-3" key={idx}>
                  <p className="w-80">
                    {renderText(
                      `${idx + 1}  Paragraph ${String.fromCharCode(65 + idx)}`,
                    )}
                  </p>
                  <div className="relative w-32">
                    ...
                    >
                      <option value="">{renderText(idx + 1)}</option>
                      {[
                        "i",
                        "ii",
                        "iii",
...
export default Test4Reading2007;
