...
const questionKeywords = [
  ["travel to work", "people", "bus", "car", "bike", "transport", "area"],
  ["traffic problems", "jam", "congestion", "road", "busy", "why"],
  ["affect you", "traffic", "late", "time", "stress", "daily life"],
  [
    "reduce traffic",
    "solution",
    "public transport",
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>How do most people travel to work where you live?</li>
            <li>What traffic problems are there in your area? [Why?]</li>
            <li>How do traffic problems affect you?</li>
            <li>How would you reduce the traffic problems in your area?</li>
          </ul>
        </div>
...
export default Test3Speaking2007;
