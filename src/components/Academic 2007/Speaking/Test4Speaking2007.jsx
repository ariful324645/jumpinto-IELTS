...
import Speaking4Pagination2007 from "../Pagination 2007/Speaking4Pagination2007";




const Test4Speaking2007 = () => {
...
const questions = [
  ...
  "What do you like doing most with your friend or friends?",
...
const questionKeywords = [
  ...
  ["doing together", "activities", "hang out", "talk", "play", "spend time"],
  [
    "keep in contact",
    "childhood friends",
    "important",
  ...
  ["good friend", "qualities", "honest", "helpful", "trust", "support"],
];
  ...
  return (
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>What do you like doing most with your friend/s?</li>
            <li>
              Do you think it's important to keep in contact with friends you
              knew as a child? [Why/Why not?]
            </li>
            <li>What makes a friend into a good friend?</li>
          </ul>
        </div>
    ...
    <Speaking4Pagination2007></Speaking4Pagination2007>
    </div>
  );
};

export default Test4Speaking2007;
