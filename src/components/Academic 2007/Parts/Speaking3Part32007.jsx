...
import Speaking3Pagination2007 from "../Pagination 2007/Speaking3Pagination2007";

const Speaking3Part32007 = () => {
...
const questionKeywords = [
  ...
  ["positive change", "benefits", "improvement", "opinion", "advantage", "why"],
  ["children", "play", "fun", "enjoyment", "interest", "games", "reason"],
  [
    "competitive games",
    "good or bad",
    "children",
  ...
  ["unite people", "teamwork", "cooperation", "social", "friendship", "games"],
  [
    "competition",
    "importance",
    "society",
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Children's games & Games and competition
            </h1>

            <p className="text-lg font-bold">Children's games</p>
            <li>How have games changed from the time when you were a child?</li>
            <li>Do you think this has been a positive change? Why?</li>
            <li>Why do you think children like playing games?</li>

            <p className="text-lg font-bold mt-4">Games and competition</p>
            <li>
              Do you think competitive games are good or bad for children? In
              what ways?
            </li>
            <li>How can games sometimes help to unite people?</li>
            <li>
              Why is competition often seen as important in today's society?
            </li>
          </ul>
      ...
      <Speaking3Pagination2007></Speaking3Pagination2007>
    </div>
  );
};

export default Speaking3Part32007;
