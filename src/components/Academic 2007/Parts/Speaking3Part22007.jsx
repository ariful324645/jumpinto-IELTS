...
const questions = [
  "What kind of game or sport is it?",
  "Who do you play it with?",
  "Where do you play it?",
];

const questionKeywords = [
  ["game", "sport", "type", "kind", "activity", "rules"],
  ["who", "friends", "family", "teammates", "partners", "players"],
  ["where", "place", "location", "field", "court", "ground", "stadium"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>what kind of game or sport it is</li>
            <li>who you play it with</li>
            <li>where you play it</li>
          </ul>
...
export default Speaking3Part22007;
