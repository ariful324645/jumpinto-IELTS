...
import Speaking1Pagination2007 from "../Pagination 2007/Speaking1Pagination2007";

const Speaking1Part32007 = () => {
...
const questionKeywords = [
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Family similarities & Genetic research
            </h1>

            <p className="text-lg font-bold">Family similarities</p>
            <li>
              In what ways can people in a family be similar to each other?
            </li>
            <li>
              Do you think that daughters are always more similar to mothers
              than to male relatives? What about sons and fathers?
            </li>
            <li>
              In terms of personality, are people more influenced by their
              family or by their friends? In what ways?
            </li>

            <p className="text-lg font-bold mt-4">Genetic research</p>
            <li>
              Where can people in your country get information about genetic
              research?
            </li>
            <li>How do people in your country feel about genetic research?</li>
            <li>
              Should this research be funded by governments or private
              companies? Why?
            </li>
          </ul>
        </div>
      ...
      <Speaking1Pagination2007></Speaking1Pagination2007>
    </div>
  );
};

export default Speaking1Part32007;
