...
const questionKeywords = [
  ["do", "activity", "work", "task", "hobby", "job"],
  ["where", "place", "location", "environment", "office", "home", "outdoors"],
  ["who", "people", "friends", "family", "colleagues", "partner"],
];
...
export default Speaking2Part22007;
