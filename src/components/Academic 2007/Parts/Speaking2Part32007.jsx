...
import Speaking2Pagination2007 from "../Pagination 2007/Speaking2Pagination2007";

const Speaking2Part32007 = () => {
...
const questionKeywords = [
  ...
  return (
    <div>
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center mb-5">
              Keeping fit and healthy & Health and modern lifestyles
            </h1>

            <p className="text-lg font-bold">Keeping fit and healthy</p>
            <li>What do most people do to keep fit in your country?</li>
            <li>
              How important is it for people to do some regular physical
              exercise?
            </li>
            ...
            <li>Why do some people choose to lead unhealthy lives?</li>
            <li>
              Should individuals or governments be responsible for making
      ...
      <Speaking2Pagination2007></Speaking2Pagination2007>
    </div>
  );
};

export default Speaking2Part32007;
