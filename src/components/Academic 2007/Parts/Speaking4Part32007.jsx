...
const questions = [
  ...
  "Do you think you made a good choice? Why/Why not?",
];

const questionKeywords = [
  ["choice", "decision", "time", "when", "occasion", "situation"],
  ["options", "alternatives", "choose between", "decision", "possibilities"],
  ["good choice", "right decision", "regret", "correct", "opinion", "why"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>when you had to make this choice</li>
            <li>what you had to choose between</li>
            <li>whether you made a good choice</li>
          </ul>
...
export default Speaking4Part22007;
