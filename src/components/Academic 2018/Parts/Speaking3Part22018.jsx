...
const questionKeywords = [
  ["subject", "discussion", "topic", "main idea"],
  ["who", "person", "discussion partner", "with whom"],
  ["opinions", "views", "thoughts", "expressed", "discussion"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              An interesting discussion you had as part of your work or studies
            </h1>
            ...
            <li>what the subject of the discussion was</li>
            <li>who you discussed the subject with</li>
            <li>what opinions were expressed</li>
          </ul>
...
export default Speaking3Part22018;
