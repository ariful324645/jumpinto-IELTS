...
const Test2Speaking2018 = () => {
  ...
  const questionKeywords = [
    ["happy", "age", "now", "feel", "why", "why not"],
    ["child", "future", "think", "past", "why", "why not"],
    ["changed", "older", "life", "difference", "why", "why not"],
    ["future", "different", "life", "change", "plans", "why"],
  ];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Age</h1>
            ...
            <li>
              Do you think you have changed as you have got older? [Why/Why
              not?]
            </li>
...
export default Test2Speaking2018;
