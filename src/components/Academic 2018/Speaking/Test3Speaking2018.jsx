...
const questionKeywords = [
  ["shopping", "pay", "cash", "card", "preference", "why"],
  ["save", "money", "special", "buy", "why", "why not"],
  ["job", "low pay", "salary", "work", "why", "why not"],
  ["winning", "money", "difference", "life", "why", "why not"],
];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Money</h1>
            <li>
              When you go shopping, do you prefer to pay for things in cash or
              by card? [Why?]
            </li>
            <li>
              Do you ever save money to buy special things? [Why/Why not?]
            </li>
            <li>Would you ever take a job which had low pay? [Why/Why not?]</li>
            <li>
...
export default Test3Speaking2018;
