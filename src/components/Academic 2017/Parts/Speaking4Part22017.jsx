...
const questions = [
  ...
  "Why did you visit this person's workplace?",
];

const questionKeywords = [
  ["who", "visited", "person", "visit"],
  ["where", "worked", "workplace", "job", "office"],
  ["why", "visited", "reason", "workplace", "purpose"],
];
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center my-5">
              A time when you visited a friend or family member at their
              workplace
            </h1>

            <p className="text-lg font-bold">
              Describe a time when you visited a friend or family member at
              their workplace.
            </p>

            <p className="text-lg font-bold">You should say:</p>

            <li>Who you visited</li>
            <li>Where this person worked</li>
            <li>Why you visited this person's workplace</li>
          </ul>
...
export default Speaking4Part22017;
