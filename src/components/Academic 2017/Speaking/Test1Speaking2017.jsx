...
const Test1Speaking2017 = () => {
  ...
  const questionKeywords = [
    ["important", "eat", "healthy", "food", "why", "why not", "health"],
    ["cold", "what do you do", "feel better", "medicine", "rest", "why"],
    ["public information", "health", "pay attention", "why", "why not"],
    ["healthier lifestyle", "exercise", "diet", "sleep", "improve health"],
  ];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Health</h1>
            ...
            <li>
              Do you pay attention to public information about health? [Why/Why
              not?]
            </li>
...
export default Test1Speaking2017;
