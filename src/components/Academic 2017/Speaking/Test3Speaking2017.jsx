...
const Test3Speaking2017 = () => {
  ...
  const questionKeywords = [
    ["buy", "clothes", "where", "shop", "why"],
    ["how often", "buy", "new clothes", "frequency", "why"],
    ["decide", "which clothes", "buy", "choice", "why", "style"],
    ["clothes", "changed", "recent years", "why", "why not", "fashion"],
  ];
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            <h1 className="text-2xl font-bold text-center">Clothes</h1>
            <li>Where do you buy most of your clothes? [Why?]</li>
            <li>How often do you buy new clothes for yourself? [Why?]</li>
            <li>How do you decide which clothes to buy? [Why?]</li>
            <li>
              Have the kinds of clothes you like changed in recent years?
              [Why/Why not?]
            </li>
...
export default Test3Speaking2017;
