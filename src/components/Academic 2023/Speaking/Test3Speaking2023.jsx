...
const questionKeywords = [
  ["often", "buy", "online", "shopping", "internet", "apps"],
  ["last", "bought", "online", "product", "purchase"],
  ["shops", "see", "buy", "online", "compare", "price"],
  ["popularity", "online", "shopping", "changing", "city", "centre", "town"],
];
    ...
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">Online shopping</h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>How often do you buy things online? Why?</li>
            <li>What was the last thing you bought online?</li>
            <li>
              Do you ever see things in shops and then buy them online? Why or
              why not?
            </li>
            <li>
              Do you think the popularity of online shopping is changing your
              town or city centre? Why or why not?
            </li>
          </ul>
        </div>
...
export default Test3Speaking2023;
