...
const questionKeywords = [
  ["kinds", "bills", "electricity", "water", "gas", "internet", "rent"],
  ["pay", "payment", "cash", "online", "card", "bank", "method"],
  ["forgotten", "forget", "late", "missed", "bill", "payment"],
  ["cheaper", "reduce", "save", "cut", "lower", "cost"],
];
    ...
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">Paying bills</h2>
          ...
          <ul className="list-disc pl-8 list-inside space-y-2">
            ...
            <li>Have you ever forgotten to pay a bill? Why or why not?</li>
            <li>
              Is there anything you could do to make your bills cheaper? Why or
              why not?
            </li>
          </ul>
        </div>
