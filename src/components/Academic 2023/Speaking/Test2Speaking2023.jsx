...
const questionKeywords = [
  ["like", "science", "school", "study", "enjoy", "boring", "interesting"],
  ["remember", "teacher", "science", "school", "class", "lesson"],
  ["interested", "science", "now", "technology", "research", "learning"],
  [
    "important",
    "recent",
    "scientific",
    ...
    <div>
      ...
      <div className="p-6 flex justify-between">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl font-bold mb-2">Science</h2>

          <ul className="list-disc pl-8 list-inside space-y-2">
            <li>
              Did you like studying science when you were at school? Why or why
              not?
            </li>
            <li>What do you remember about your science teachers at school?</li>
            <li>How interested are you in science now? Why or why not?</li>
            <li>
              What do you think has been an important recent scientific
              development? Why?
            </li>
          </ul>
        </div>
